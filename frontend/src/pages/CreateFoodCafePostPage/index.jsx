...
import { useCreateFoodCafePost } from "./useCreateFoodCafePost";
            ...
            <div className="flex flex-col gap-6 pb-8 min-w-0">
              <Card variant="card" className="bg-[#1A2F45]/60 border-white/5 !p-6">
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-2 bg-orange-500/20 text-orange-400 rounded-lg"><Edit3 className="w-5 h-5" /></div>
                  <div>
                    <h3 className="text-lg font-bold">Basic Information</h3>
                    <p className="text-text-secondary text-xs mt-0.5">Enter the core details of your food item or promotion</p>
                  </div>
                </div>
                <div className="flex flex-col gap-6">
                  ...
                  <div>
                    ...
                    <textarea value={description} onChange={(e) => setDescription(e.target.value)}
                      placeholder="Describe your special menu items, ambiance, or promotions..." rows={6}
            ...
            <div className="flex flex-col gap-6 sticky top-4 h-fit min-w-0">
              ...
              <div className="flex gap-4 mb-8">
                ...
                <button type="button" onClick={handlePublish} disabled={loading}
                  ...
                  {loading ? "Publishing..." : "Publish Food Post"}
                </button>
              </div>
            </div>
          </div>
