        ...
        <div className="flex flex-col gap-xl w-full max-w-[1122px]">
            ...
            <Card variant="container" className="h-40 relative group transition-colors">
                ...
                <div className="absolute top-[80px] left-lg">
                    <p className="text-body-small-bold text-text-secondary">Total Pending</p>
                </div>
            ...
            <Card variant="container" className="h-40 relative group transition-colors">
                ...
                <div className="absolute top-[80px] left-lg">
                    <p className="text-body-small-bold text-text-secondary">Approved Today</p>
                </div>
            ...
            <Card variant="container" className="h-40 relative group transition-colors">
                ...
                <div className="absolute top-[80px] left-lg">
                    <p className="text-body-small-bold text-text-secondary">Rejected Today</p>
                </div>
                <div className="absolute top-[100px] left-lg">
