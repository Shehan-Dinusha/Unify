      ...
      <div className="flex flex-col items-center gap-6 z-10 w-full max-w-2xl">
        ...
        <Card variant="card" className="w-full max-w-[600px]" padding="p-8">
            ...
            {submissionStatus === 'idle' ? (
                <>
                    {/* Info Banner */}
                    <div className="bg-white/5 rounded-xl border border-white/20 p-2.5 mb-4 flex gap-3 items-start">
                ...
                <>
                    ...
                    <p className="text-text-secondary text-sm text-center mb-4 leading-relaxed font-bold px-4">
                        {submissionStatus === 'pending' && (
                             <>Your documents have been submitted and are currently <br/>under review by the administration. You will be notified via email once the process is complete.</>
                        )}
                    ...
                    <div className="flex flex-col gap-2 mb-4">
                        <div className="flex justify-between items-center">
                            <span className="text-text-secondary text-xs font-bold">Submitted Documents</span>
                        ...
                        <div className="pt-4 border-t border-primary-blue/20 flex flex-col gap-2">
                             ...
                             {submissionStatus === 'declined' && (
                                <>
                                    ...
                                    >
                                        <span className="font-semibold text-sm">Resubmit Documents</span>
                                    </Button>
                                    <p className="text-text-tertiary text-xs text-center">
                                        You can update your documents and try again immediately.
                                    </p>
                                </>
                             )}
                        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-sm bg-gray-900 rounded-3xl p-6 border border-white/10 shadow-xl flex flex-col items-center text-center animate-in fade-in zoom-in duration-200">
                ...
                <p className="text-text-secondary text-sm mb-6 leading-relaxed">
                    Are you sure you want to withdraw your club verification application? This will <span className="text-red-400 font-bold">permanently delete all uploaded documents</span> and reset your status.
                </p>
