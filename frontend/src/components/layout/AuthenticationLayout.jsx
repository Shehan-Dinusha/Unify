...
const AuthenticationLayout = ({ children }) => {
  return (
    <div className="min-h-screen bg-app-bg flex flex-col font-inter relative overflow-x-hidden md:overflow-hidden selection:bg-primary-blue/30">
      ...
      {/* Page Content */}
      <main className="flex-1 min-h-[calc(100vh-80px)] md:min-h-0 flex flex-col items-center justify-start md:justify-center px-8 lg:px-28 relative z-10 w-full pt-28 md:pt-20 pb-8 md:pb-0">
        {children}
      </main>
