...
const FileUpload = ({ 
    ...
    return (
        <div className="flex flex-col gap-2 w-full">
            {label && (
                <label className="text-text-secondary text-xs font-bold uppercase tracking-wider">{label}</label>
            )}
            {description && (
            ...
            >
                ...
                <div className="h-32 flex flex-col items-center justify-center p-4">
                    {selectedFile ? (
                        ...
                        <>
                            <Upload className={`w-10 h-10 mb-3 transition-colors ${dragActive ? 'text-primary-blue' : 'text-text-secondary group-hover:text-primary-blue'}`} />
