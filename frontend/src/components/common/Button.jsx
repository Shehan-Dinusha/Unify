...
const Button = ({ 
  ...
  // Base styles
  const baseStyles = "inline-flex items-center justify-center transition-all duration-200 overflow-hidden font-inter active:scale-[0.98] disabled:opacity-50 disabled:active:scale-100 disabled:cursor-not-allowed";
  ...
  // Variant Mapping
  const variants = {
    primary: "bg-primary-blue text-white shadow-custom hover:brightness-110 active:bg-blue-700",
    outline: "border-2 border-primary-blue text-primary-blue hover:bg-primary-light active:bg-primary-blue/20",
    ...
    dangerOutline: "border-2 border-state-error text-state-error hover:bg-state-error/10",
