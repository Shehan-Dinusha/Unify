...
describe("getEventsToday Controller", () => {
  it("returns 200 with events list", async () => {
    ...
    const { getEventsToday } =
      await import("../../../../src/controllers/newsfeed/getEventsToday.controller.js");
...
describe("getNewAnnouncements Controller", () => {
  it("returns 200 with announcements list", async () => {
    ...
    const { getNewAnnouncements } =
      await import("../../../../src/controllers/newsfeed/getNewAnnouncements.controller.js");
  ...
  it('tags GENERAL category posts as postType "normal"', async () => {
    mock.method(NormalPost, "findAll", async () => [
      makeAnnouncement({ category: "GENERAL" }),
    ]);
    mock.method(ClubEventPost, "findAll", async () => []);
    mock.method(ClubProductPost, "findAll", async () => []);
  ...
  it('tags all NormalPost announcements as postType "normal"', async () => {
    mock.method(NormalPost, "findAll", async () => [
      makeAnnouncement(),
      makeAnnouncement({ id: 2, title: "Post 2" }),
    ]);
    mock.method(ClubEventPost, "findAll", async () => []);
    mock.method(ClubProductPost, "findAll", async () => []);
...
describe("getMarketplaceItemsToday Controller", () => {
  it("returns 200 with marketplace items list", async () => {
    ...
    const { getMarketplaceItemsToday } =
      await import("../../../../src/controllers/newsfeed/getMarketplaceItemsToday.controller.js");
