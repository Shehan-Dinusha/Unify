...
// Get top-level admin dashboard statistics (student count, boost revenue, active businesses).
...
//Get weekly/monthly registration, revenue, and business growth data for chart carousel.
...
//Get report moderation status breakdown (resolved, reviewing, pending).
...
//Get active business counts by category for the engagement progress bars.
...
//Get revenue overview stats (total, boosts, avg spend, projected annual).
...
//Get monthly actual vs projected revenue for the line chart.
